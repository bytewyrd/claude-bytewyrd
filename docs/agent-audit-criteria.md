...
When unsure, prefer the cheaper tier and pin it explicitly; under-pinning is a one-line edit to fix. Note that `docs/rfc-process.md` requires `model: opus` for RFC-related agent tasks by default — `/rfc-new` may ask the human to opt into `model: fable` for the `rfc-architect` drafting step specifically, but every other RFC-related spawn (review agents, `/rfc-consensus-review`, `/rfc-implement`) stays on opus regardless of the agent's frontmatter. The frontmatter `model:` is the default for non-RFC invocations.
...
|-------|------|--------------|------------------|--------|
| ai-engineer | 1 | 2026-05-12 | v1 | pass |
| api-designer | 2 | 2026-05-12 | v1 | pass |
| backend-developer | 3 | 2026-05-12 | v1 | pass |
| build-engineer | 3 | 2026-05-12 | v1 | pass || claude-agent-author | 1 | 2026-05-12 | v1 | pass with deviations |
| cli-developer | 3 | 2026-05-12 | v1 | pass |
| cloud-architect | 2 | 2026-05-12 | v1 | pass |
| code-reviewer | 1 | 2026-05-12 | v1 | pass |
| database-administrator | 2 | 2026-05-12 | v1 | pass |
| database-optimizer | 3 | 2026-05-12 | v1 | pass |
| debugger | 1 | 2026-05-12 | v1 | pass |
| deployment-engineer | 3 | 2026-05-12 | v1 | pass |
| devops-engineer | 3 | 2026-05-12 | v1 | pass || devops-incident-responder | 3 | — | — | pending |
| devops-incident-responder | 3 | 2026-05-12 | v1 | pass || docs-agent | 1 | 2026-05-12 | v1 | pass |
...
| ui-designer | 3 | 2026-05-12 | v1 | pass |
| ux-design-architect | 2 | 2026-05-12 | v1 | pass |
| websocket-engineer | 3 | 2026-05-12 | v1 | pass |
